...
%if %{with cuda}
# BuildRequires:  cuda-toolkit-12-8
...
if ! [ -f "%{_builddir}/cuda/bin/nvcc" ]; then
    %define cuda_prefix https://developer.download.nvidia.com/compute/cuda/
    %ifarch aarch64
        %define cuda_suffix _sbsa
    %endif

    %define cuda_url %{cuda_prefix}%{cuda_version}/local_installers/cuda_%{cuda_version}_%{cuda_build}_linux%{?cuda_suffix}.run
    wget \
        "%{cuda_url}" \
...
%if %{with cuda}
    ...
    -DCMAKE_CUDA_ARCHITECTURES="50;60;61;70;75;80;86;87;89;90;90a;120" \
%endif
